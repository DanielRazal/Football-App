...
The Football-App project has been deployed to the Internet. You can access it using the following URL: [https://football-app-a0be1.web.app/](https://football-app-a0be1.web.app/)
